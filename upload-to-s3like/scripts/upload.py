#!/usr/bin/env python3
"""
CLI for uploading files to S3 and S3-compatible object storage.

Usage:
    python scripts/upload.py --path ./file.txt --bucket mybucket
    python scripts/upload.py --path ./folder --bucket mybucket --prefix uploads/

Required environment variables:
    SKILL__S3_ACCESS_KEY - S3 access key
    SKILL__S3_SECRET_KEY - S3 secret key
"""
...
Examples:
    ...
    python scripts/upload.py --path ./folder --bucket mybucket --concurrency 10 --retries 3
